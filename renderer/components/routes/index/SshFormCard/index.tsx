...
const SshFormCard = (): ReactElement => {
  ...
  const {
    ...
    defaultValues: {
      host: "zenesta.laggron.red",
      port: 22,
      secretType: SecretType.PrivateKey,
      username: "zenesta",
      secret: "",
      keyPath: "F:\\Project\\Cloud Computing\\sshkey\\id_dsa",
    },
  ...
  */
  ...
  const keyPlaceholder = useAsync<string>(async () => {
  ...
  return (
    <Card size="3" onPointerDown={handleClickRipple} onKeyDown={handleKeyDown} onMouseDown={() => setCustomError("")}>
            ...
            {watch("secretType") !== SecretType.Password ? (
              ...
              >
                <Controller
                  ...
                  control={control}
                  render={({ field }) => (
                    <TextField.Root type="text" placeholder={keyPlaceholder} {...field}>
                      <TextField.Slot>
